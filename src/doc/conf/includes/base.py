...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "doc"),
        "USER": config("DB_USER", "doc"),
        "PASSWORD": config("DB_PASSWORD", "doc"),
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "doc.utils.context_processors.settings",
            ],
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(LOGGING_DIR, "doc.log"),
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "doc.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
    "django_auth_adfs_db.backends.AdfsAuthCodeBackend",
]

SESSION_COOKIE_NAME = "doc_sessionid"
...
DOCUMENT_TOKEN_TIMEOUT_HOURS = 1
